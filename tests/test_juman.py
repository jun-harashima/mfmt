...
def test__to_vaporetto(juman: Juman, lines: list[str]) -> None:
    actual = juman._to_vaporetto(lines)
    expected = [
        "今日/名詞-時相名詞/きょう は/助詞-副助詞/は よい/形容詞/よい 天気/名詞-普通名詞/てんき です/判定詞/です 。/特殊-句点/。",  # noqa: E501
    ]
    assert actual == expected
